...
const PHASES: RoadmapPhase[] = [
  ...
  },
  {
    ...
    items: [
      { text: "Agenda de citas con confirmación automática" },
      { text: "Médicos referidores con portal propio" },
      { text: "Reportes exportables por sucursal" },
      { text: "Alertas de órdenes pendientes vía WhatsApp" },
      { text: "Panel de auditorías de acceso" },
    ],
  },
  {
    status: "planned",
    label: "Próximamente",
    period: "2026",
    title: "Expansión e integración",
    items: [
      { text: "App móvil para técnicos de campo" },
      { text: "API abierta para integraciones HIS/LIS" },
      { text: "White label para distribuidores" },
      { text: "Inteligencia de resultados (valores críticos)" },
